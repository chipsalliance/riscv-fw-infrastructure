...
/* Get the highest priority level in meiplS (External Interrupt Priority Level Register)
 * In case of standard-priority-order the priority is 15, in case of reversed priority order - 0 */
#define M_PSP_MACHINE_EXT_INT_GET_PRIORITY_HIGHEST_VALUE \
...
#define M_PSP_MACHINE_EXT_INT_GET_PRIORITY_TO_MASK \
    (M_PSP_READ_REGISTER_32(D_PSP_PIC_MPICCFG_ADDR) & D_PSP_MPICCFG_PRIORD_MASK) == D_PSP_EXT_INT_STANDARD_PRIORITY \
...
#define M_PSP_MACHINE_EXT_INT_GET_THRESHOLD_MASK_ALL \
    (M_PSP_READ_REGISTER_32(D_PSP_PIC_MPICCFG_ADDR) & D_PSP_MPICCFG_PRIORD_MASK) == D_PSP_EXT_INT_STANDARD_PRIORITY \
...
#define M_PSP_MACHINE_EXT_INT_GET_THRESHOLD_TO_UNMASK_ALL \
    (M_PSP_READ_REGISTER_32(D_PSP_PIC_MPICCFG_ADDR) & D_PSP_MPICCFG_PRIORD_MASK) == D_PSP_EXT_INT_STANDARD_PRIORITY \
