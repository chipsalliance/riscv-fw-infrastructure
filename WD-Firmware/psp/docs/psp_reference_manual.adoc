...
|1 |Sep 2, 2021 |Initial draft |Pasha Tikhonov +
Ibrahim Qashqoush
|=============================================
...
| D_DCCM_SECTION_START_ADDRESS | SweRV_EH2 | The flag is required to support
...
https://bitbucket.wdc.com/projects/CTORISCVFWINFRA/repos/riscv-fw-infrastructure/browse/coding_convention.adoc[conding convention].
...
<<psp_macros_eh1_ref, EH1>> and <<psp_macros_eh2_ref, EH2>> subsections add
SweRV specific macros per core version.

include::{include_dir}/psp_macros.adoc[leveloffset=+3]
include::{include_dir}/psp_macros_eh1.adoc[leveloffset=+3]
...
<<psp_macros_asm_eh1_ref, EH1>> and <<psp_macros_asm_eh2_ref, EH2>> subsection
add SweRV specific macros per core version.

include::{include_dir}/psp_macros_asm.adoc[leveloffset=+3]
include::{include_dir}/psp_macros_asm_eh1.adoc[leveloffset=+3]
include::{include_dir}/psp_macros_asm_eh2.adoc[leveloffset=+3]
