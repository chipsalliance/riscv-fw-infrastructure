...
|========================================================================
| *Name* |*Comment*
| M_PSP_MACHINE_EXT_INT_PRIORITY_SET_TO_HIGHEST_VALUE  | Set the highest
...
|M_PSP_MACHINE_EXT_INT_PRIORITY_SET_TO_MASKED_VALUE | When set this priority
level in meiplS (External Interrupt Priority Level Register), the corresponding
...
| M_PSP_MACHINE_EXT_INT_THRESHOLD_MASK_ALL_VALUE | When setting this threshold
...
| M_PSP_MACHINE_EXT_INT_THRESHOLD_UNMASK_ALL_VALUE | When setting this threshold
level in meipt (External Interrupt Priority Threshold Register), no interrupt
will be masked (all served). In case of standard priority order - 0, in case of
reversed priority order - 15
|========================================================================
