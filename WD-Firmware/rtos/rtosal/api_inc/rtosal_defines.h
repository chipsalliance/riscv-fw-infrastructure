...
#ifndef D_NUM_OF_HARTS
#define D_NUM_OF_HARTS 1
#endif /* D_NUM_OF_HARTS */
  ...
  #define D_RTOSAL_FEATURE_NOT_ENABLED          0xFF
    ...
    #define D_RTOSAL_NUM_OF_CORES              D_NUM_OF_HARTS
  ...
  #if D_ENABLE_FREERTOS_SMP == 1
    #define D_RTOSAL_NUM_OF_CORES              TBD_TAKE_VAL_FROM_TX
  #endif /* D_ENABLE_FREERTOS_SMP */
#else
